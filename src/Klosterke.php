...
class Klosterke
{
    ...
    {
        $product = ProductFabriek::create($this->naam, $this->kwaliteit, $this->verkopenVoor);
        $product->tick();
        $this->kwaliteit = $product->kwaliteit; 
        $this->verkopenVoor = $product->verkopenVoor;
    }
